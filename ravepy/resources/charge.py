...
class BaseCharge:
    ...
    def capture(self):
        ...
        RaveChargeError
        """
        raise NotImplementedError("Capture is not implemented on this charge type")

    def void(self):
        """
        Voids a preauth transaction .
        """
        raise NotImplementedError("Void is not implemented on this charge type")

    def refund(self):
        """
        Refunds a transaction.
        """
        raise NotImplementedError("refund is not implemented on the charge type")
